...
contract Interaction is Ownable {
    ...
    event NewSetAddr(
        ...
        address bondingCurveContractAddr
    );
    ...
    function setAddr(
        ...
        require(
            _bondingCurveContractAddr != address(0),
        ...
        emit NewSetAddr(
            _vestingContractAddr,
            _tokenContractAddr,
            _bondingCurveContractAddr
        );
    }
    ...
    {
        require(
            _genesisInvestorWalletAddr != address(0),
            "Cannot be zero address"
        );
    ...
    function _isGenesisInvestors(address _genesisInvestorWalletAddr)
        internal
        view
        returns (bool)
    {
        for (uint256 i = 0; i < genesisInvestor.length; i++) {
     ...
     */
    function mintAndCreateVesting(address userAddress, uint256 amount)
        public
        onlyBondingCurve
    {
        /**
