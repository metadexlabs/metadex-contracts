...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    function getRandomNumber() external override {
        require(msg.sender == metaDexLottery, "Only MetaDexLottery");
    ...
    /**
     * @notice Set the address for the MetaDexLottery
     * @param _metaDexLottery: address of the MetaDexLottery lottery
     */
    function setLotteryAddress(address _metaDexLottery) external onlyOwner {
        metaDexLottery = _metaDexLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IMetaDexLottery(metaDexLottery).viewCurrentLotteryId();
    }
}
